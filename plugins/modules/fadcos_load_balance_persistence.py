...
rep_dict = {
    'name': 'mkey',
    'ipv4_maskbits': 'ipv4-maskbits',
    'ipv6_maskbits': 'ipv6-maskbits',
    'match_across_virtual_servers': 'match-across-servers',
    ...
    'iso8583_bitmap_relation': 'iso8583_bitmap-relation',
    'keyvalue_relation': 'keyvalue-relation',
    'names': 'mkeys',
}
...
def add_obj(module, connection):
    ...
    url = obj_url
    if is_vdom_enable(connection) and vdom:
        url += '?vdom=' + vdom
